...
public class FXCM2 extends BaseTest {

	@Test(dataProvider = "ReadFromExcel")

	public void fXCM2(Hashtable<String, String> data) throws Exception {

		rep = ExtentManager.getInstance();
		test = rep.startTest("FXCM Back Test");
