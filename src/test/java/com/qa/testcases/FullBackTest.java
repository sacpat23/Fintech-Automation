...
public class FullBackTest extends BaseTest {
	@Test(dataProviderClass = TestUtils.class, dataProvider = "dp")
	//@Test(dataProvider = "ReadFromExcel")

	public void fullBackTest(Hashtable<String, String> data) throws Exception {
		
		if (!TestUtils.isTestRunnable("fullBackTest", excel)) {
